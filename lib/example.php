...
$quote_resp = Quote::get_quote(Array('garment[0][product_id]'=> 3, 'garment[0][color]'=> 'White', 'garment[0][sizes][med]'=> 100,
                         'print_type'=> 'DTG Print', 'print[front][color_count]'=> 5, 'use_third_party_shipping'=> 0));
...
$data_ups = array(
        ...
        'addresses[0][batch][0][sizes][med]'=> 2,
        'addresses[0][batch][0][sizes][lrg]'=> 2,
        'addresses[0][ship_type]'=> 'ups',
